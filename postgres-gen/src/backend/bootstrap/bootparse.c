...
#line 1 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
...
union YYSTYPE
{
#line 85 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
...
#line 137 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 146 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 1371 "bootparse.c"
  ...
  case 16: /* $@1: %empty  */
#line 155 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					numattr = 0;
...
#line 1385 "bootparse.c"
  ...
  case 17: /* $@2: %empty  */
#line 165 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					do_end();
				}
...
#line 169 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					TupleDesc	tupdesc;
...
#line 1477 "bootparse.c"
  ...
  case 19: /* $@3: %empty  */
#line 252 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
...
#line 258 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
...
#line 271 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
...
#line 323 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					IndexStmt  *stmt = makeNode(IndexStmt);
					Oid			relationId;
...
#line 375 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
...
#line 387 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
					do_start();
					build_indices();
					do_end();
...
#line 396 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.list) = lappend((yyvsp[-2].list), (yyvsp[0].ielem)); }
#line 1636 "bootparse.c"
    break;

  case 26: /* boot_index_params: boot_index_param  */
#line 397 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.list) = list_make1((yyvsp[0].ielem)); }
#line 1642 "bootparse.c"
    break;

  case 27: /* boot_index_param: boot_ident boot_ident  */
#line 402 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
...
#line 417 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.ival) = 1; }
#line 1665 "bootparse.c"
    break;

  case 29: /* optbootstrap: %empty  */
#line 418 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 0; }
#line 1671 "bootparse.c"
    break;

  case 30: /* optsharedrelation: XSHARED_RELATION  */
#line 422 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = 1; }
#line 1677 "bootparse.c"
    break;

  case 31: /* optsharedrelation: %empty  */
#line 423 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                                { (yyval.ival) = 0; }
#line 1683 "bootparse.c"
    break;

  case 32: /* optrowtypeoid: XROWTYPE_OID oidspec  */
#line 427 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                { (yyval.oidval) = (yyvsp[0].oidval); }
#line 1689 "bootparse.c"
    break;

  case 33: /* optrowtypeoid: %empty  */
#line 428 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                                        { (yyval.oidval) = InvalidOid; }
#line 1695 "bootparse.c"
    break;

  case 36: /* boot_column_def: boot_ident EQUALS boot_ident boot_column_nullness  */
#line 438 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                {
				   if (++numattr > MAXATTR)
...
#line 446 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                { (yyval.ival) = BOOTCOL_NULL_FORCE_NOT_NULL; }
#line 1711 "bootparse.c"
    break;

  case 38: /* boot_column_nullness: XFORCE XNULL  */
#line 447 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                {  (yyval.ival) = BOOTCOL_NULL_FORCE_NULL; }
#line 1717 "bootparse.c"
    break;

  case 39: /* boot_column_nullness: %empty  */
#line 448 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                  { (yyval.ival) = BOOTCOL_NULL_AUTO; }
#line 1723 "bootparse.c"
    break;

  case 40: /* oidspec: boot_ident  */
#line 452 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                                                                        { (yyval.oidval) = atooid((yyvsp[0].str)); }
#line 1729 "bootparse.c"
    break;

  case 44: /* boot_column_val: boot_ident  */
#line 463 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                        { InsertOneValue((yyvsp[0].str), num_columns_read++); }
#line 1735 "bootparse.c"
    break;

  case 45: /* boot_column_val: NULLVAL  */
#line 465 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                        { InsertOneNull(num_columns_read++); }
#line 1741 "bootparse.c"
    break;

  case 46: /* boot_ident: ID  */
#line 469 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = (yyvsp[0].str); }
#line 1747 "bootparse.c"
    break;

  case 47: /* boot_ident: OPEN  */
#line 470 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1753 "bootparse.c"
    break;

  case 48: /* boot_ident: XCLOSE  */
#line 471 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1759 "bootparse.c"
    break;

  case 49: /* boot_ident: XCREATE  */
#line 472 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1765 "bootparse.c"
    break;

  case 50: /* boot_ident: INSERT_TUPLE  */
#line 473 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1771 "bootparse.c"
    break;

  case 51: /* boot_ident: XDECLARE  */
#line 474 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1777 "bootparse.c"
    break;

  case 52: /* boot_ident: INDEX  */
#line 475 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1783 "bootparse.c"
    break;

  case 53: /* boot_ident: ON  */
#line 476 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1789 "bootparse.c"
    break;

  case 54: /* boot_ident: USING  */
#line 477 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1795 "bootparse.c"
    break;

  case 55: /* boot_ident: XBUILD  */
#line 478 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1801 "bootparse.c"
    break;

  case 56: /* boot_ident: INDICES  */
#line 479 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1807 "bootparse.c"
    break;

  case 57: /* boot_ident: UNIQUE  */
#line 480 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1813 "bootparse.c"
    break;

  case 58: /* boot_ident: XTOAST  */
#line 481 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1819 "bootparse.c"
    break;

  case 59: /* boot_ident: OBJ_ID  */
#line 482 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1825 "bootparse.c"
    break;

  case 60: /* boot_ident: XBOOTSTRAP  */
#line 483 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1831 "bootparse.c"
    break;

  case 61: /* boot_ident: XSHARED_RELATION  */
#line 484 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1837 "bootparse.c"
    break;

  case 62: /* boot_ident: XROWTYPE_OID  */
#line 485 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1843 "bootparse.c"
    break;

  case 63: /* boot_ident: XFORCE  */
#line 486 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1849 "bootparse.c"
    break;

  case 64: /* boot_ident: XNOT  */
#line 487 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
#line 1855 "bootparse.c"
    break;

  case 65: /* boot_ident: XNULL  */
#line 488 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
                                        { (yyval.str) = pstrdup((yyvsp[0].kw)); }
...
#line 490 "/home/hailey/code/minigres/postgres-build/../postgres/src/backend/bootstrap/bootparse.y"
